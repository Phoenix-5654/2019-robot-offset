...
class PhysicsEngine(object):
    ...
    def __init__(self, physics_controller):
        ...
        self.drivetrain = tankmodel.TankModel.theory(
            ...
            56 * units.kg,  # robot mass
            10.71,  # drivetrain gear ratio
            2,  # motors per side
            69 * units.cm,  # robot wheelbase
            89.5 * units.cm+ bumper_width * 2,  # robot width
            62 * units.cm + bumper_width * 2,  # robot length
    ...
    def update_sim(self, hal_data, now, tm_diff):
        ...
        hal_data["CAN"][1]["quad_position"] = int(self.l_distance * self.kEncoder)
        hal_data["CAN"][3]["quad_position"] = int(self.r_distance * self.kEncoder)

        print(hal_data["CAN"][1]["quad_position"])
